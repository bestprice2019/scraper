...
my_url = 'https://www.paknsaveonline.co.nz'
...
for url in category_list:
	...
	my_url = 'https://www.paknsaveonline.co.nz/category/'+url
	...
	while count < total_pages+1:
		...
		for product in products:
			...
			#f.write(title +"," +price +"\n")
			f.write("PS" +"," +title.replace(',','|') +"," +price.replace('$','').replace(' ea','') +"\n")
